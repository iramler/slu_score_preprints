...
editor: 
  canonical: true
image: Krispy_Kreme_Challenge_2010.webp
categories:
  - Data Visualization
  - Data Wrangling
  - Joining / Merging
...
- [doughnut2015.csv](doughnut2015.csv): adjusted race results
- [doughnut2015unadj.csv](doughnut2015unadj.csv): unadjusted race results
- [doughnuttime.csv](doughnuttime.csv): the “bonus time thresholds” for each doughnut
...
[https://truetimeracing.com/event/doughnut-run-2015/](https://truetimeracing.com/event/doughnut-run-2015/){target="_blank"}
[https://truetimeracing.com/event/doughnut-run-2015/](https://truetimeracing.com/event/doughnut-run-2015/){target="_blank"}
[https://github.com/iramler/stat450-spr2026-score/blob/main/donuts/donut_times.jpg](https://github.com/iramler/stat450-spr2026-score/blob/main/donuts/donut_times.jpg){target="_blank"}
...
- Data Visualization with ggplot2 [https://ggplot2.tidyverse.org/](https://ggplot2.tidyverse.org/){target="_blank"}

- Working with Dates and Times in R [https://lubridate.tidyverse.org/](https://lubridate.tidyverse.org/){target="_blank"}



<!--
https://krispykremechallenge.com/about-virtual-race
-->