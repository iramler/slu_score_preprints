...
c. Create a scatterplot using `wingspan_advantage` as the explanatory variable and `3pt_rate` as the response variable. Include a regression line, a title, and labels for the x and y axes. Then use `facet_wrap()` to separate the plot by `position`. What patterns or relationships stand out within or across positions?
```{r}
