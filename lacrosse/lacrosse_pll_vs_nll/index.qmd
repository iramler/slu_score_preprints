...
* [lacrosse_pll_vs_nll_statkey_worksheet.docx](lacrosse_pll_vs_nll_statkey_worksheet.docx)- Activity worksheet to compare scoring and shots between indoor and outdoor leagues using randomization tests implements via [StatKey](https://www.lock5stat.com/StatKey/){target="_blank"}.
