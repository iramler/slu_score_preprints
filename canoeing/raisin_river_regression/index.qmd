...
author:
  ...
  - name: Robin Lock
    ...
    affiliation:
      - ref: slu
resources: raisin_river_module_SOLUTIONS.pdf
format: 
      html:
...
This could serve as an in class activity and should take between 30 and 45 minutes to complete.
:::

::: {.callout-note collapse="true" title="Learning Objectives" appearance="minimal"}
By the end of this activity, students will:

1.  Increase ability to find and investigate outliers and unusual points in a dataset using leverage, standardized residuals, and Cook's D.

2.  Be able remove influential observations from a dataset and rerun an analysis to see how resutls are affected.
:::
...
Students will need to use R or other statistics software like Minitab.
:::
...
| flow     | Flow of the water (indicative of water level) in ft\^3/sec |
...
-   [Module Worksheet (Generic software Version)](raisin_river_module_worksheet.docx)

-   [Solutions to Worksheet (R/Quarto Version)](raisin_river_module_SOLUTIONS.qmd)

-   [Solutions to Worksheet (R version as html with expandable solutions)](raisin_river_module_SOLUTIONS.html)

-   [Solutions to Worksheet - generic (Word)](raisin_river_module_SOLUTIONS.docx)
