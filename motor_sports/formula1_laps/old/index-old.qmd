...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Q-jjZMMxbZs?si=h2TwCz-DTvr64HNC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
...
1.  Improve their understanding of the concept of histograms and their relevance in statistical analysis.

2.  Identify potential outliers in a numerical variable using numerical methods such as the "1.5 IQR Rule".

3.  Explore the effect outliers have on the data/summary statistics.

4 (Optional) Be able to compare and contrast distributions to further understand histograms, outliers, and their impacts on race results.
:::

::: {.callout-note collapse="true" title="Methods" appearance="minimal"}
This activity is a reinforcement module that assumes the student has already been introduced to the following topics.

1.  Histograms: Familiarity with histograms as a graphical representation of a numerical variable (like lap times) is crucial. Students should have been exposed how to interpret histograms, using shape, center, and spread of distributions.
...
[Class handout](Miami2023Worksheet-v2.docx)

[Class handout with sample solutions](Miami2023WorksheetKey-v2.docx)

Students may also benefit from seeing the following map of the race track. Note that the numbers represent the different turns and the narrow line (next to turn 19) is the pit stop lane. Red arrow indicates the direction of the race.

![Map of 2023 Miami Grand Prix track](Hard_Rock_Stadium_Circuit_2022.svg)
...
-   Track Map: By <a href="//commons.wikimedia.org/w/index.php?title=User:GabrielStella&amp;action=edit&amp;redlink=1" class="new" title="User:GabrielStella (page does not exist)">GabrielStella</a> - [Own work]{.int-own-work lang="en"}, <a href="https://creativecommons.org/licenses/by-sa/3.0" title="Creative Commons Attribution-Share Alike 3.0">CC BY-SA 3.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=103863916">Link</a>
