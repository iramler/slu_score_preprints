...
<iframe width="560" height="315" src="https://www.youtube.com/embed/KwdUKP-mLzA?si=KXpc-DONjKuPHlVW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
:::
...
2. Use simulation tools (StatKey or R) to create sampling distributions of the sample mean.
...
- Knowledge of Normal Distributions is required for the optional portion of the handout.
:::
...
[Class Handout - MS Word version using StatKey](nba_sampling_dist_worksheet.docx)

[Class handout - with solutions](nba_sampling_dist_solutions.docx)
