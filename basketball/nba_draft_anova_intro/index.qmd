...
There are two version of the handout:

- In one version, no explicit technology is necessary other than a calculator.

- The other is based on using R, but can be modified to use any statistical software capable of running one-way ANOVA.
:::
...
- [R/Quarto handout](nba_draft_anova_tech.qmd)
- [HTML rendered R/Quarto handout with expandable solutions](nba_draft_anova_tech_SOLUTIONS.html)
