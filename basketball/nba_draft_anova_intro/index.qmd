...
- This module is suitable for an introductory or intermediate statistics course that covers one-wat ANOVA.
...
- There are three versions of the handout available in @sec-materials:
  ...
  - The other two use eithero R or Python to visualize the data and produce the ANOVA output.

- Students should be provided with the data file (.csv) provided in @sec-data and one of the handouts (software choice determines which handot to use).
:::
...
- Other two use R and Python respectively to visualize the data and produce the ANOVA output.
:::
