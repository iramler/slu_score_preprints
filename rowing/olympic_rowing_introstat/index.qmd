...
Click the following link to access the materials (opens a new tab): [https://modules.scorenetwork.org/rowing/olympic_rowing_introstat/](https://modules.scorenetwork.org/rowing/olympic_rowing_introstat/){target="_blank"}
