...
Click the following link to access the materials (opens a new tab): [https://modules.scorenetwork.org/rowing/olympic_rowing_datawrangling/](https://modules.scorenetwork.org/rowing/olympic_rowing_datawrangling/){target="_blank"}
