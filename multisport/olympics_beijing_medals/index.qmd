...
1.  R Packages: Familiarity with the `tidyverse` suite of packages. In addition to the basic verbs in `dplyr`, students should be familiar with the separate command (`tidyr`) and joining commands (`dplyr`).
