...
2.  Use the *NFLPoints* dataset to apply the chosen inference procedure to answer some set of the questions.
:::
...
The questions in this activity cover many of the topics involving inference for means or proportions with applications dealing with point spreads and scores of NFL games.
:::
